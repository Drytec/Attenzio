...
from .views import home, user_login_view, user_singup_view, select_user_type_view,logout_view, UserLoginAPIView, TeacherRegisterAPIView, StudentRegisterAPIView
